public class Main 
{
	public static void main(String[] args)
	{
		...
		student.setSurname("Öztürk");
		student.setEmail("myemail@gmail.com");	
		student.setPassword("mypassword");
		System.out.println(student.getId()+" id'li öğrenci adı ve soyadı: "+student.getName()+" "+student.getSurname()+","+
				"Bu öğrencinin mail adresi "+student.getEmail());
		
		Instructor instructor = new Instructor();
		instructor.setId(1);
		instructor.setName("Orhan");
		instructor.setSurname("Öztürk");
		instructor.setEmail("myemail@gmail.com");
		instructor.setPassword("mypassword");
		System.out.println(student.getId()+" id'li eğitmenin adı ve soyadı: "+instructor.getName()+" "+instructor.getSurname()+","+
